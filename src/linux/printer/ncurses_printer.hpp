...
// TODO: add descr
//class NCursesPrinter : public IPrinter
//{
//    public:
//        // TODO: check n
//        explicit NCursesPrinter(int n);
//
...
//
//    private:
//        void print_system(const SystemInfo &system_info);
//
//        void print_cpu(const SystemInfo &system_info);
//
//        void print_processes(const SystemInfo &system_info);
//
