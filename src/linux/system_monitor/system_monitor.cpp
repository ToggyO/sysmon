...
std::string SystemMonitor::collect_os_name() { return m_common_data_reader->get_os_name(); }
...
void SystemMonitor::collect_processes_info(SystemInfo &system_info)
{
    ...
    std::sort(processes.begin(), processes.end(), [](const Process &p1, const Process &p2) { return p2 < p1; });
