...
{
public:
    explicit SystemFilesReaderLinux(std::shared_ptr<IFileDescriptorsCache> fd_cache_ptr);
...
private:
    ...
    static void create_path_from_segments(std::filesystem::path &result, const std::string &root,
