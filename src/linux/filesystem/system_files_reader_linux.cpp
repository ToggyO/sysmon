...
{
    fd_cache_ptr->save_by_file_path(LinuxConstants::k_proc_stat_file, create_fd(LinuxConstants::k_proc_stat_file));
    fd_cache_ptr->save_by_file_path(LinuxConstants::k_pwd_path, create_fd(LinuxConstants::k_pwd_path));
    fd_cache_ptr->save_by_file_path(LinuxConstants::k_os_file_path, create_fd(LinuxConstants::k_os_file_path));
    fd_cache_ptr->save_by_file_path(LinuxConstants::k_uptime_file_path, create_fd(LinuxConstants::k_uptime_file_path));
    fd_cache_ptr->save_by_file_path(LinuxConstants::k_proc_meminfo_file_path, create_fd(LinuxConstants::k_proc_meminfo_file_path));
}
...
void SystemFilesReaderLinux::create_path_from_segments(
