...
Element FtxUiPrinter::build_system(const SystemInfo &system_info)
{
    ...
    return vbox({
        ...
        hbox({
            text(FtxUiHelpers::PrintingConstants::k_uptime) | color(FtxUiHelpers::CommonColors::Text::title_text),
            text(uptime) | color(FtxUiHelpers::CommonColors::Text::value_text),
        }),
        hbox({
            text(FtxUiHelpers::PrintingConstants::k_load_avg) | color(FtxUiHelpers::CommonColors::Text::title_text),
